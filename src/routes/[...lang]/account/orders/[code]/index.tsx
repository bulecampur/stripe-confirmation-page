			...
			<dl class="border-t mt-6 border-gray-200 py-6 space-y-6">
				<div class="flex items-center justify-between">
					...
					<dd class="text-sm font-medium">
						{formatPrice(locale, store.order?.subTotal, store.order?.currencyCode || 'EUR')}
					</dd>
				</div>
				<div class="flex items-center justify-between">
					<dt class="text-sm">
					...
					<dd class="text-sm font-medium">
						{formatPrice(locale, store.order?.shippingWithTax, store.order?.currencyCode || 'EUR')}
					</dd>
				</div>
				<div class="flex items-center justify-between">
				...
				<div class="flex items-center justify-between border-t border-gray-200 pt-6">
					...
					<dd class="text-base font-medium">
						{formatPrice(locale, store.order?.totalWithTax, store.order?.currencyCode || 'EUR')}
					</dd>
				</div>
			</dl>

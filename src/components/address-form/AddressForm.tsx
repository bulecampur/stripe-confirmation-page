						...
						<div class="mt-1">
							<input
								...
								onChange$={(ev) =>
									(appState.shippingAddress = {
										...appState.shippingAddress,
										streetLine1: (ev.target as HTMLInputElement).value,
									})
								}
								class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm"
							/>
						...
						<div class="mt-1">
							<input
								...
								onChange$={(ev) =>
									(appState.shippingAddress = {
										...appState.shippingAddress,
										streetLine2: (ev.target as HTMLInputElement).value,
									})
								}
							/>
						</div>
							...
							{appState.availableCountries && (
								<select
									...
									onChange$={(ev) =>
										(appState.shippingAddress = {
											...appState.shippingAddress,
											countryCode: (ev.target as HTMLInputElement).value,
										})
									}
								>
						...
						<div class="mt-1">
							<input
								...
								onChange$={(ev) =>
									(appState.shippingAddress = {
										...appState.shippingAddress,
										province: (ev.target as HTMLInputElement).value,
									})
								}
								class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm"
							/>
						...
						<div class="mt-1">
							<input
								...
								onChange$={(ev) =>
									(appState.shippingAddress = {
										...appState.shippingAddress,
										postalCode: (ev.target as HTMLInputElement).value,
									})
								}
								class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm"
							/>
						...
						<div class="mt-1">
							<input
								...
								onChange$={(ev) =>
									(appState.shippingAddress = {
										...appState.shippingAddress,
										phoneNumber: (ev.target as HTMLInputElement).value,
									})
								}
								class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm"
							/>
						...
						<div class="mt-1">
							<input
								...
								onChange$={(ev) =>
									(appState.shippingAddress = {
										...appState.shippingAddress,
										defaultShippingAddress: (ev.target as HTMLInputElement).checked,
									})
								}
							/>
						</div>
						...
						<div class="mt-1">
							<input
								...
								onChange$={(ev) =>
									(appState.shippingAddress = {
										...appState.shippingAddress,
										defaultBillingAddress: (ev.target as HTMLInputElement).checked,
									})
								}
							/>
						</div>

...
export const AdvancedMetricType = {
  Currency: 'currency',
  Number: 'number'
} as const;

export type AdvancedMetricType = typeof AdvancedMetricType[keyof typeof AdvancedMetricType];
...
export const HistoryEntryType = {
  ...
  StripeSubscriptionNotification: 'STRIPE_SUBSCRIPTION_NOTIFICATION'
} as const;
...
export type Mutation = {
  ...
  convertOrderToDraft?: Maybe<Order>;
...
export type MutationConvertOrderToDraftArgs = {
  id: Scalars['ID']['input'];
};
